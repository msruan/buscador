...
export class Downloader {
    ...
    async  readWebPageHTML(url : string) : Promise<string>{
    ...
    async  downloadPages(url : string) : Promise<void>{
     ...
     downloadPage(text: string, page_name : string) : void{
     ...
     jaVisiteiEssaPagina(file_name : string){
     ...
     takeLastElement(url : string) : string{
     ...
     trasnformarURLRelativaEmNormal(urlPaginaInicial : string, urlRelativa : string){
     ...
     contarOcorrenciasSubstring(str : string, substr : string){
