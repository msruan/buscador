...
function calcularUsoDeTags(html : string, searched_term : string, scoresDefault : ScoreObject){
    ...
    for(let a of as){
        ifa.text.toLocaleLowerCase().includes(searched_term.toLocaleLowerCase()))
            h2s_ocorrencias++;
    }
}
