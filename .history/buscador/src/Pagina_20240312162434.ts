...
export class Pagina {
    ...
    calcularUsoDeTags(html : string, searched_term : string, scores : ScoreObject){
    ...
    calcularFrescor(html : string, searched_term : string, scores : ScoreObject){
        const DOOM = parse(html);
        const ps = DOOM.querySelectorAll("p");
        for(let p of ps){
