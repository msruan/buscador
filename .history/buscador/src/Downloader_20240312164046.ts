...
export class Downloader {
    ...
    async private readWebPageHTML(url : string) : Promise<string>{
    ...
    async private downloadPages(url : string) : Promise<void>{
        ...
        for(let a of links){
            ...
            let page_name : string = tthis.akeLastElement(href);
